...
<div id="info2" style="display:none">
    <h2>Ананьева Наталия Исаевна (прием ведется в МДЦ «Рэмси Диагностика»)</h2><img src="<?php echo $base; ?>/img_thirdDesign/1.jpg" alt="alt" style="float: left;margin-right: 20px;">
...
<div id="info6" style="display:none">
    <h2>Макогонова Марина Евгеньевна (прием ведется в МДЦ «Рэмси Диагностика»)</h2><img src="<?php echo $base; ?>/img_thirdDesign/4.jpg" alt="alt" style="float: left;margin-right: 20px;">
